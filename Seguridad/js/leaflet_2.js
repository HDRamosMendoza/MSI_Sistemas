...
let OpenStreetsMap = L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png',{
...
var basemaps = {
    ...
    'Manzanas': L.tileLayer.wms('http://geo.munisanisidro.gob.pe:8080/geoserver/msigeoportal/wms', {
        layers:'tg_manzanas',
        format:'image/png',
        transparent:true,
        maxZoom:30
...
var map = L.map('map', {
    ...
    zoom: 6,
    layers: [OpenStreetsMap, basemaps['Manzanas']]
});
...
let baseLayers = {
    "MSI - Distritos Colindantes": L.tileLayer.wms('http://geo.munisanisidro.gob.pe:8080/geoserver/msigeoportal/wms', {
        attribution: 'Distritos Colindantes © <a href="http://msi.gob.pe/portal/"> Munic. de San Isidro</a> Lima - Perú',
        format: 'image/png',
        layers: 'glayer_Trama_externa',
        maxZoom: 30
    }),
    "OSM - Open Streets Map": OpenStreetsMap
};
